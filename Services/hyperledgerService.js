...
var createAdmin = function(details,callback){
    var data_to_send = {
        ...
        request({
            url: 'http://18.237.110.210:3000/api/Admin', //URL to hit
            method: 'POST',
...
var createEventManager = function(details,callback){
    var data_to_send = {
        ...
        request({
            url: 'http://18.237.110.210:3000/api/EventManager', //URL to hit
            method: 'POST',
            form: data_to_send //Set the body as a string
        }, function(error, response, body){
            if(error) {
...
var createAtendee = function(details,callback){
    var data_to_send = {
        ...
        request({
            url: 'http://18.237.110.210:3000/api/Attendee', //URL to hit
            method: 'POST',
            form: data_to_send //Set the body as a string
        }, function(error, response, body){
            if(error) {
...
var createEvent = function(details,callback){
    var data_to_send = {
        ...
        request({
            url: 'http://18.237.110.210:3000/api/EEvent', //URL to hit
            method: 'POST',
            form: data_to_send //Set the body as a string
        }, function(error, response, body){
            if(error) {
...
var createTicket = function(details,callback){
    var data_to_send = {
        ...
        request({
            url: 'http://18.237.110.210:3000/api/CreateTickets', //URL to hit
            method: 'POST',
            form: data_to_send //Set the body as a string
        }, function(error, response, body){
            if(error) {
...
var getBoughtTickets = function(details,callback){
    ...
    var query = 'http://18.237.110.210:3000/api/Ticket'
    request({
        url: query ,
...
var buyTicket = function(details,callback){
    var data_to_send = {
        ...
        request({
            url: 'http://18.237.110.210:3000/api/BuyTicket', //URL to hit
            method: 'POST',
            form: data_to_send //Set the body as a string
        }, function(error, response, body){
            if(error) {
